  ...
  return (
    <>
      ...
      <nav
        ...
        } lg:block lg:visible lg:opacity-100 lg:sticky top-0 lg:w-[22rem] lg:border-r lg:border-gray-500/80  [backdrop-filter:blur(15px);]  w-full h-screen bg-zinc-900/80 px-5 py-10 translate-x-0 md:translate-x-[none] transition-all duration-500 min-h-screen z-[100] `}
      >
        <AppHeader headingLevel="h2" className="flex flex-col mb-5 lg:hidden">
